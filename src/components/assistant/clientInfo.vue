	...
	<div class="client-item">
	  <div class="client-info">
	  	...
	  	<div class="right-icon">
	  		...
	  		<a :href="'tel:'+vpreferredtel" v-if="isphone"><span class="phone"></span></a>
	  	</div>
	  	<clear></clear>
	  </div>
...
import {getCusDetails} from '@/api/getData'
  export default {
    name: 'clientInfo',
    props: ['name', 'level', 'fcustype', 'vpreferredtel', 'fproceedingtype', 'dproceedingts', 'id', 'pk_project', 'isgrade', 'shide', 'isphone', 'pk_customerway', 'pk_customer_sellor', 'vdef5', 'vdef10', 'reserve10'],
    data() {
      return {
      ...
      async getCusDetail() {
        ...
        console.log(res)
           if (res.data.flag === '0') {
             ...
             if (this.infoList.vdef9 === null) {
                personalInfo.totalPrice.value = '请选择总价预算'
             } else {
             ...
             personalInfo.projectName.code = this.$store.state.selectedProject.outpk_project
