...
<script>
import notFollowClient from '@/components/assistant/notFollowClient'
...
import {followUrg} from '@/api/getData'
  export default {
    ...
    components: {
      notFollowClient, commonFooter, clear
    },
    methods: {
      async getAPPList() {
        let params = {
