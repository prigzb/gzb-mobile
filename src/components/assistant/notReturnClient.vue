...
import {getCusDetails} from '@/api/getData'
  export default {
    name: 'notReturnClient',
    props: ['name', 'grade', 'type', 'phone', 'fproceedingtype', 'dproceedingdate', 'id', 'isgrade', 'shide', 'isphone', 'pk_customerway', 'pk_customer_sellor', 'vdef5', 'vdef10', 'reserve10'],
    data() {
      return {
