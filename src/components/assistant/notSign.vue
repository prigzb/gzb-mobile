...
<script>
import notSignClient from '@/components/assistant/notSignClient'
...
import {followUrg} from '@/api/getData'
  export default {
    ...
    components: {
      notSignClient, commonFooter, clear
    },
    methods: {
      async getAPPList() {
        let params = {
