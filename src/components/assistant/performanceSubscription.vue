<template>
	<div class="performanceSubscription">
    ...
    <form>
      <div class="search">
		...
		<subscriptionItem v-for="rengouMess in rengouMesss" :customerName='rengouMess.customername' :phone="rengouMess.tel" :place="rengouMess.housecode" :billid="rengouMess.billid" v-if="rengouMesss.length > 0">
		</subscriptionItem>
    <div class="no-content" v-if="rengouMesss.length == 0">
  ...
  import clear from '@/components/clear'
    ...
    methods: {
      async getMess() {
        ...
        console.log(res)
        this.rengouMesss = res.data.data.list
      }
    },
    created: function() {
      this.getMess()
